...
from modules._beziercurve import BezierCurve
from modules._utils import isListOfPoints, isNumeric
...
class HumanCurve():
    ...
    def generateInternalKnots(self, \
        ...
        leftBoundary, rightBoundary = int(leftBoundary), int(rightBoundary)
        downBoundary, upBoundary = int(downBoundary), int(upBoundary)
